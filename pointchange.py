...
def main():
    ...
    value.append(str(numpy.random.uniform(-3,3))+'E+03') #M_2
    ...
    value.append('#') #A_d
    value.append('#') #A_e
    value.append(str(numpy.random.uniform(-3,3))+'E+03') #mu
    ...
    value.append(str(numpy.random.uniform(0,3))+'E+03') #M_q1L
    value.append(value[18])                 #M_q2L
    value.append(str(numpy.random.uniform(0,3))+'E+03') #M_q3L
    value.append(str(numpy.random.uniform(0,3))+'E+03') #M_uR
